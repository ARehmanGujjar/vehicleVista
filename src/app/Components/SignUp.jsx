...
<div className="h-full text-gray-900 flex justify-center">
    <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        <div className="lg:w-1/2 xl:w-5/12 p-2 sm:p-2">
            <div>
                <img src="/images/common/appLogo.png" alt="logo"
...
<div className=" p-2 flex justify-center items-center">
 <div className="w-full max-w-2xl mb-10 mx-auto">
    <label className="text-muted" htmlFor="searchIn">
        What best describes you?
    </label>

    <div className="flex flex-auto justify-evenly border rounded-md w-full">

        <button className="border-none px-2 text-white bg-[#071952] py-1 rounded-md w-full">
            <input type="radio" className="hidden" id="searchMCQs"/>
            <label className="cursor-pointer" htmlFor="searchMCQs">User</label>
        </button>

        <button className="border-none px-2 py-1 rounded-md w-full">
            <input type="radio" className="hidden" id="searchTopics"/>
            <label className="cursor-pointer" htmlFor="searchTopics">Inspector</label>
        </button>
